...
public class RankingAndPreferenceSelectionv2<S extends Solution<?>>
    ...
    int rankingIndex = 0;
    /** Constructor */
    public RankingAndPreferenceSelectionv2(int solutionsToSelect,List<Double> interestPoint,double epsilon) {
